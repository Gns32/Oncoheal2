...
class SimpleNivoSliderAdmin {
	...
	public function load_custom_wp_admin_style() {
		if ( $this->is_my_plugin_screen() ) {
			...
			wp_enqueue_script( 'simplenivoslider-admin-js', plugin_dir_url( __DIR__ ) . 'js/jquery.simplenivoslider.admin.js', array( 'jquery' ), '1.00', false );
			wp_enqueue_media();
		}
	}
	...
	<div id="simplenivoslider-admin-tabs">
	  <ul>
		<li><a href="#simplenivoslider-admin-tabs-1">NivoSlider&nbsp<?php esc_html_e( 'Settings' ); ?></a></li>
		<li><a href="#simplenivoslider-admin-tabs-2"><?php esc_html_e( 'Settings' ); ?></a></li>
		<li><a href="#simplenivoslider-admin-tabs-3"><?php esc_html_e( 'Documents' ); ?></a></li>
		<li><a href="#simplenivoslider-admin-tabs-4"><?php esc_html_e( 'Donate to this plugin &#187;' ); ?></a></li>
	  </ul>

	  <div id="simplenivoslider-admin-tabs-1">
		<div class="wrap">
			<h2>NivoSlider <?php esc_html_e( 'Settings' ); ?>(<a href="https://github.com/Codeinwp/Nivo-Slider-jQuery" target="_blank" style="text-decoration: none; word-break: break-all;"><?php esc_html_e( 'Website' ); ?></a>)</h2>	
			<h3><?php esc_html_e( 'Shortcode attributes take precedence. If the attribute is omitted, the following settings are applied.', 'simple-nivoslider' ); ?></h3>
	  ...
	  <div id="simplenivoslider-admin-tabs-2">
		<div class="wrap">
			...
			<h3><?php esc_html_e( 'Can specify without writing the shortcode.', 'simple-nivoslider' ); ?></h3>
			...
			<?php wp_nonce_field( 'add_cbo', 'add_code_body_open' ); ?>
				...
				<?php submit_button( __( 'Register' ), 'primary', 'BodyOpenCode', false ); ?>
	  ...
	  <div id="simplenivoslider-admin-tabs-3">
		<div class="wrap">
			...
			?>
			<h2><?php esc_html_e( 'Documents' ); ?>(<?php echo wp_kses_post( $screenshot_html ); ?>)</h2>

			<li style="margin: 0px 40px;">
			<h3><?php esc_html_e( 'Write a Shortcode. The following text field. Enclose image tags and gallery shortcode.', 'simple-nivoslider' ); ?></h3>
			<h3><?php esc_html_e( 'example:', 'simple-nivoslider' ); ?></h3>
...
&lt;a href="http://blog3.localhost.localdomain/wp-content/uploads/sites/8/2017/01/f878ff71.jpg"&gt;&lt;img src="http://blog3.localhost.localdomain/wp-content/uploads/sites/8/2017/01/f878ff71.jpg" alt="" width="1000" height="666" class="alignnone size-full wp-image-274" /&gt;&lt;/a&gt;&#91gallery size="full" ids="273,272,271,270"&#93&#91/simplenivoslider&#93</code></h3>
			...
			<li style="margin: 0px 40px;">
			<h3><?php esc_html_e( 'Write a Shortcode. The following template. Enclose image tags and gallery shortcode.', 'simple-nivoslider' ); ?></h3>
			<h3><?php esc_html_e( 'example:', 'simple-nivoslider' ); ?></h3>
			...
			<li style="margin: 0px 40px;">
			<h3><?php esc_html_e( '"Simple NivoSlider" activation, you to include additional buttons for Shortcode in the Text (HTML) mode of the WordPress editor.', 'simple-nivoslider' ); ?>
			</h3>
			</li>
			<li style="margin: 0px 40px;">
			<h3><?php esc_html_e( 'Within the Shortcode, it is possible to describe multiple galleries and multiple media.', 'simple-nivoslider' ); ?>
			</h3>
			</li>
	...
	private function options_updated() {
		...
		if ( ! empty( $_POST ) ) {
			if ( isset( $_POST['simplenivoslider_set'] ) && ! empty( $_POST['simplenivoslider_set'] ) ) {
