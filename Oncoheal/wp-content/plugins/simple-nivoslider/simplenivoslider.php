...
add_action( 'plugins_loaded', 'simple_nivoslider_load_textdomain' );
/** ==================================================
 * i18n
 *
 * @since 1.00
 */
function simple_nivoslider_load_textdomain() {
	load_plugin_textdomain( 'simple-nivoslider' );
}

if ( ! class_exists( 'SimpleNivoSliderRegist' ) ) {
	require_once( dirname( __FILE__ ) . '/lib/class-simplenivosliderregist.php' );
}
